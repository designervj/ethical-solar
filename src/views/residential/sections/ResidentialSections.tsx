...
export function ResidentialHero({ title, highlight, description, formTitle, formSubtitle }: any) {
  return (
...
export function ResidentialBenefits({ heading, description, benefits, incentives }: any) {
  return (
...
export function ResidentialHowItWorks({ heading, description, steps }: any) {
  return (
...
export function ResidentialProcess({ heading, description, steps }: any) {
  return (
    <section className="bg-white py-20 md:px-0 px-4">
